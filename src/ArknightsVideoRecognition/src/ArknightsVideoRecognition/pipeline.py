...
from ArknightsVideoRecognition.battle import (
...
from ArknightsVideoRecognition.copilot import (
    Action as CopilotAction,
    ActionType,
    CopilotJob,
    Direction,
)
from ArknightsVideoRecognition.formation import FormationAnalyzer, FormationOper
from ArknightsVideoRecognition.ocr.engine import OcrEngine
from ArknightsVideoRecognition.stage import StageRecognizer
from ArknightsVideoRecognition.video import VideoFrames, VideoSlicer
...
class VideoRecognitionPipeline:
    ...
    def __init__(
        ...
        from ArknightsVideoRecognition.battle.buttons import BattleButtonDetector
        from ArknightsVideoRecognition.battle.deployment import DeploymentAnalyzer
