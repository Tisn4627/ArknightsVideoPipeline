...
from ArknightsVideoRecognition.config.roi import get_roi
from ArknightsVideoRecognition.config.settings import AVATAR_DIR, DATA_DIR, SUPPORT_TEMPLATE
...
class FormationAnalyzer:
    ...
    def analyze(self, formation_frame: np.ndarray) -> list[FormationOper]:
        ...
        from ArknightsVideoRecognition.vision.templ_det_ocrer import TemplDetOCRer
